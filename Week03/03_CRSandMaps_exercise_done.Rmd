...
```{r inspect-data}
# displaying the nitrates_sf and places_sf and viewing their structure

nitrates_sf
places_sf

# displaying the elevation object and viewing its structure
elevation
```
...
places4326 <- places_sf %>% st_set_crs("EPSG:4326")

nitrates25832 <- nitrates_sf %>% st_set_crs("EPSG:25832")
...
```{r reproject-crs}
# transforming the nitrates dataset into the coordinate reference system used in the places object

nitrates_4326 <- st_transform(nitrates25832, crs = st_crs(places4326))
