...
plot(aarhus(shelters_buf, col = "green")
plot(aarhus(shelters, pch = 2 ,add = TRUE)
plot(aarhus, stretch = "lin",add = TRUE)
plot(aarhus(df_buf), col = "firebrick",add = TRUE)
plot(aarhus(df_crs), pch = 16, add = TRUE)
